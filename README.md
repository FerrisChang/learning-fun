                ...
                <div class="companies-table-frame">
                    <div class="table mra-table">
                      ...
                      <ng-container matColumnDef="request_id">
                          <th mat-header-cell *matHeaderCellDef (click)="sort('request_id')" class="sortable-header">
                              <div class="header-content">
                                  MRA Request ID
                      ...
                      <ng-container matColumnDef="count">
                          <th mat-header-cell *matHeaderCellDef (click)="sort('count')" class="sortable-header">
                              <div class="header-content">
                                  Company Count
                      ...
                      <ng-container matColumnDef="country">
                          <th mat-header-cell *matHeaderCellDef (click)="sort('country')" class="sortable-header">
                              <div class="header-content">
                                  Country
                      ...
                      <ng-container matColumnDef="flags">
                          ...
                          <td mat-cell *matCellDef="let mraRequest">
                              <button *ngIf="mraRequest.flags.mraStatus" mat-raised-button [matTooltip]="generateStatusTooltip(mraRequest.flags.mraStatus)"
                              [matTooltipClass]="'status-tooltip'"
                              matTooltipPosition="right">Status</button>
                          </td>
                      </ng-container>
                      ...
                      <ng-container matColumnDef="date_updated">
                          <th mat-header-cell *matHeaderCellDef (click)="sort('date_updated')" class="sortable-header">
                              <div class="header-content">
                                  Last Updated Date
...
.mra-table .mat-mdc-header-row,
.mra-table .mat-mdc-row.table-row {
  display: grid;
...
.mra-table .mat-mdc-header-cell,
.mra-table .mat-mdc-cell {
...
.mra-table .mat-mdc-row.table-row:hover .mat-mdc-cell {
  background-color: rgb(184, 181, 181);
}

.mra-table .mat-mdc-row.table-row.selected .mat-mdc-cell {
  background-color: rgb(227 237 246);
}

.mra-table .mat-mdc-row.table-details-row,
.mra-table .mat-mdc-row.table-details-row .mat-mdc-cell {
  display: block;
